<template>
  <div class="app-container">
    ...
    <div class="filter-container" style="margin-bottom: 15px">
      ...
      <br>
      <br>
      <el-button v-waves style="font-size: 20px;" class="filter-item" type="primary"  @click="handleFilter">
        搜索
      </el-button>
      
      <el-button v-permission="['admin']" class="filter-item" style="margin-left: 10px;font-size: 20px;" type="primary"  @click="handleCreate">
        添加图书
      </el-button>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button @click="handleBorrow(scope.row)" type="success"  style="font-size: 16px;"> 借阅</el-button>
        </template>
      </el-table-column>
    </el-table>
